  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white pb-20 relative">
      ...
      <button
        ...
        className="fixed bottom-20 right-4 z-40 bg-green-600 hover:bg-green-500 hover:scale-105 active:scale-95 text-white w-12 h-12 rounded-full shadow-[0_4px_16px_rgba(22,163,74,0.4)] flex items-center justify-center transition-all duration-300 group border border-green-500/35"
